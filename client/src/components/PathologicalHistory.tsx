...
import { PathologicalList } from "../models/patient";
...
type Props = {
  pathologicalList: PathologicalList[];
};
export default function PathologicalHistory({ pathologicalList }: Props) {
