            ...
            <Grid container spacing={1}>
              ...
              <Grid item xs={12} md={10}>
                <FormControl component="fieldset">
                  <FormLabel component="legend">Datos personales</FormLabel>
                  <FormGroup row>
                    <TextField
                      variant="filled"
                      id="firstname"
              ...
              <Grid item xs={12} md={8}>
                <FormControl component="fieldset">
                  ...
                  <FieldArray
                    ...
                    render={(arrayHelpers) => (
                      <FormGroup row>
                        {formik.values.alergies?.map((alergy, index) => (
                          <div key={index}>
                            <TextField
                              fullWidth
                              variant="filled"
                              name={`alergies.${index}.name`}
                              label="Nombre"
                              value={alergy.name}
                              onChange={formik.handleChange}
                            />
                            <TextField
                              ...
                              multiline
                              rows={4}
                              name={`alergies.${index}.description`}
                              label="Description"
                              value={alergy.description}
                              onChange={formik.handleChange}
                            />
                            <IconButton
